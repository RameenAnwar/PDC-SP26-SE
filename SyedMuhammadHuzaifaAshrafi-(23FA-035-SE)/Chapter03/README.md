...
**Example implementation ([spawning_processes.py](Codes/spawning_processes.py)):**
```python
...
**Worker Module ([myFunc.py](Codes/myFunc.py)):**
```python
def myFunc(i):
    print ('calling myFunc from process n°: %s' %i)
    for j in range (0,i):
...
**Spawning Script ([spawning_processes_namespace.py](Codes/spawning_processes_namespace.py)):**
```python
import multiprocessing
...
**Example implementation ([naming_processes.py](Codes/naming_processes.py)):**
```python
import multiprocessing
import time
...
**Example implementation ([run_background_processes.py](Codes/run_background_processes.py)):**
```python
import multiprocessing
import time
...
**Example implementation ([run_background_processes_no_daemons.py](Codes/run_background_processes_no_daemons.py)):**
```python
import multiprocessing
import time
...
**Example implementation ([killing_processes.py](Codes/killing_processes.py)):**
```python
import multiprocessing
import time
...
**Example implementation ([process_in_subclass.py](Codes/process_in_subclass.py)):**
```python
import multiprocessing
...
**Example implementation ([communicating_with_queue.py](Codes/communicating_with_queue.py)):**
```python
import multiprocessing
import random
import time
...
**Example implementation ([communicating_with_pipe.py](Codes/communicating_with_pipe.py)):**
```python
...
**Example implementation ([processes_barrier.py](Codes/processes_barrier.py)):**
```python
import multiprocessing
...
**Example implementation ([process_pool.py](Codes/process_pool.py)):**
```python
