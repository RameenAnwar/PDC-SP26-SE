...
**Example implementation ([helloworld_MPI.py](Codes/helloworld_MPI.py)):**
```python
#hello.py
...
**Example implementation ([pointToPointCommunication.py](Codes/pointToPointCommunication.py)):**
```python
from mpi4py import MPI
...
**Example implementation ([deadLockProblems.py](Codes/deadLockProblems.py)):**
```python
from mpi4py import MPI
...
**Example implementation ([broadcast.py](Codes/broadcast.py)):**
```python
from mpi4py import MPI
...
**Example implementation ([scatter.py](Codes/scatter.py)):**
```python
from mpi4py import MPI
...
**Example implementation ([gather.py](Codes/gather.py)):**
```python
from mpi4py import MPI
...
**Example implementation ([alltoall.py](Codes/alltoall.py)):**
```python
from mpi4py import MPI
import numpy
...
**Example implementation ([reduction.py](Codes/reduction.py)):**
```python
import numpy as np
from mpi4py import MPI
...
**Example implementation ([virtualTopology.py](Codes/virtualTopology.py)):**
```python
from mpi4py import MPI
import numpy as np
